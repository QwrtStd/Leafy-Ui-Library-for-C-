...
// --- TextInput focus system ---
std::string* activeTextInput = nullptr; // wskazuje na aktualnie aktywne pole

// --- Layout implementacja ---
...
bool TextInput(std::string &value, int maxLength) {
    ...
    // kliknięcie myszą ustawia focus
    ...
    // przyjmowanie znaków tylko jeśli aktywne
    if(activeTextInput == &value) {
    ...
    // Enter zwraca true tylko dla aktywnego pola
    return (activeTextInput == &value) && IsKeyPressed(KEY_ENTER);
}
